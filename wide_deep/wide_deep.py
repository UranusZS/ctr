...
from build_feature_columns import read_columns_cfg
from build_feature_columns import get_feature_columns
from build_feature_columns import build_feature_columns


_CSV_COLUMNS, _CSV_COLUMN_DEFAULTS = read_columns_cfg(filename="columns.txt")
...
parser.add_argument(
    '--export_dir', type=str, default='/tmp/census_export',
...
def build_estimator(model_dir, model_type):
  ...
  feature_columns_dict = build_feature_columns(fc_cfg_file="feature_columns.cfg")
  wide_columns, deep_columns = get_feature_columns(feature_columns_dict,
          ["wide", "deep"]) 
...
def main(unused_argv):
  ...
  train_spec = tf.estimator.TrainSpec(input_fn=lambda: input_fn(
        FLAGS.train_data, FLAGS.epochs_per_eval, True, FLAGS.batch_size),
        max_steps=FLAGS.train_epochs * _NUM_EXAMPLES["train"] / FLAGS.batch_size)
